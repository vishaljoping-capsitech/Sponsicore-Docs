        ...
        text={
          <>
            ...
            <ul className="docs-list">
              <li>
                Displays the total task count for the last 7 days, including
                today, giving you a clear snapshot of your team's activity.
              </li>
              <li>
                Highlights the Pending Task count to ensure critical items don't
                slip through the cracks.
              </li>
              <li>
                Apply the Job Type filter to focus on specific roles, making
                task management precise and efficient.
              </li>
              <li>
                Clicking on the task count lets you view detailed data, export
                reports, or notify employees directly , ensuring timely action.
              </li>
              <li>
                The Search Filter allows quick access to specific tasks for
                better visibility with the help of searching by employee's name.
              </li>
              <li>
