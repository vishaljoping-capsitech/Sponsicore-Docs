                ...
                text={<ul>
                    <li><Title text={"Comprehensive Branch Controls:"} />
                        ...
                        <ul>
                            ...
                            <li><Title text={"Edit Branches:"} /> Existing branch details can be updated, including contact info, status, or other key information to keep records current.
                    ...
                    <li><Title text={"Main Branch Protection:"} />
                        The main branch holds a special status and cannot be deleted, deactivated, or renamed. This safeguard ensures the integrity of the core company data and prevents accidental changes that could disrupt critical operations.
                        <ImageCard src={images.adminCompanyBranchOverview} /></li>
                    <li><Title text={"Branch Creation with Settings Copy:"} />
                        When creating a new branch, admins have the convenient option to copy settings and configurations from the main branch. This feature speeds up setup time by automatically applying standard parameters, ensuring consistency across branches.
                        <ImageCard src={images.adminCompanyAddBranch} /></li>
                </ul>} />
        </>
    )
