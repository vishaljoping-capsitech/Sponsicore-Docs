        ...
        <>
            <Paragraph
                text={<ul>
                    ...
                    <li><Title text={"Dynamic Data Views:"} /> While search and sorting help you adjust the on-screen view, all applied filters will also be reflected in the exported reports, ensuring accuracy and consistency.</li>
